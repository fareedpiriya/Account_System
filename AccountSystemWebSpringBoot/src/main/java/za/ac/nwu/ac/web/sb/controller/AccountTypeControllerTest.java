...
//
//    @Mock
//    private FetchAccountTypeFlowImpl fetchAccountTypeFlowImpl;
//
//    @Mock
//    private CreateAccountTypeFlowImpl createAccountTypeFlowImpl;
//
//    @Mock
...
//        when(fetchAccountTypeFlowImpl.getAllAccountTypes()).thenReturn(accountTypes);
...
//                .andReturn();
//        verify(fetchAccountTypeFlowImpl, times(1)).getAllAccountTypes();
...
//        when(createAccountTypeFlowImpl.create(eq(accountType))).then(returnsFirstArg());
...
//                .andReturn();
//        verify(createAccountTypeFlowImpl, times(1)).create(eq(accountType));
